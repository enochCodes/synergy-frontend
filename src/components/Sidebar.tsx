...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="relative">
      ...
      >
        {/* Branding */}
        <div className="w-full bg-blue-600 text-white flex items-center justify-center py-4 shadow-md">
        ...
        <div className="p-6 border-t border-gray-200">
          <button className="flex items-center space-x-3 px-4 py-3 rounded-lg font-medium text-gray-700 hover:bg-red-50 hover:text-red-500 transition duration-200">
